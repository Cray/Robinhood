...
# Release: 3%{?config_dependant}%{?db_dependant}%{?dist}
...
Generated using options:  '--with-purpose=LUSTRE_HSM'
...
* Wed Mar 03 2010 Thomas Leibovici <thomas.leibovici@cea.fr> 2.1.2
